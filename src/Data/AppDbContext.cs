...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder mb)
    {
        ...
        mb.Entity<FaixaPrecoChacara>()
            .HasIndex(f => new { f.LojaId, f.PessoasAte });

        mb.Entity<FaixaPrecoChacara>()
            .Property(f => f.ValorDiariaSemana).HasColumnType("decimal(10,2)");
        mb.Entity<FaixaPrecoChacara>()
        ...
        mb.Entity<MovimentoCaixa>()
            ...
            .HasForeignKey(m => m.LojaId).OnDelete(DeleteBehavior.Cascade);
        ...
        mb.Entity<ModuloPreco>().HasData(
            ...
            new ModuloPreco { Id = Guid.Parse("11111111-1111-1111-1111-111111111104"), Chave = "etiquetas", Nome = "Impressão de etiquetas", Valor = 29.90m, DisponivelParaAtivar = true },
